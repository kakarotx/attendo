...
class CreateClass extends StatefulWidget {
  CreateClass({this.currentUser, this.toggleScreenCallBack});
            ...
            children: [
              ...
              Container(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('IMPORTANT',style: TextStyle(color: CupertinoColors.destructiveRed),),
                    SizedBox(height: 4,),
                    Text('1. Enter a CourseName for the course you want to create'
                        ' as well as the year of the batch.'),
                    SizedBox(height: 10,),
                    Text("2. A Code for your class will be provided to you which you can share"
